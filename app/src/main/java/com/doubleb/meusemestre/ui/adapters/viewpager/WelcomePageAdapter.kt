...
class WelcomePageAdapter(fragmentActivity: FragmentActivity) :
    ...
    override fun createFragment(position: Int) =
        when (position) {
            ...
            1 ->
                WelcomeInfoFragment.newInstance(
                    R.drawable.vector_updated_grades,
            ...
            2 ->
                WelcomeInfoFragment.newInstance(
                    R.drawable.vector_register_grades,
