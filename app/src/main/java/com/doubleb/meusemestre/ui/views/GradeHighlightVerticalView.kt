...
class GradeHighlightVerticalView @JvmOverloads constructor(
    ...
    init {
        View.inflate(context, R.layout.view_grade_highlight_vertical, this)
        radius = resources.getDimension(R.dimen.spacing_eight)
        useCompatPadding = true
    }

    fun name(name: String) = apply {
        grade_highlight_vertical_grade_variation.name(name)
    }

    fun grade(grade: Float) = apply {
        grade_highlight_vertical_grade_variation.grade(grade)
    }
    ...
    fun variation(variation: Float) = apply {
        ...
        grade_highlight_vertical_grade_variation.variation(variation)
    }
}